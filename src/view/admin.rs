...
pub fn remove_duplicates_button() -> maud::Markup {
    maud::html! {
        button hx-post="/admin/remove-duplicates"
               hx-target="#main-content"
               hx-swap="innerHTML"
               hx-confirm="Are you sure you want to remove duplicate songs? This action cannot be undone."
